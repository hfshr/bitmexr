...
The following examples will use the tn_* varients of the managing trades functions (`tn_place_order()`, `tn_edit_order()` and `tn_cancel_order()`) to access the testnet API. These function will work in exactly the same way when using the live API.
