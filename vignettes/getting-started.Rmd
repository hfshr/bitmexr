...
Take our desired 5-day time period again. Using `map_bucket_trades()` will create the necessary number of API requests to satisfy the desired sample time frame automatically.
...
Instead, this function prints the maximum timestamp from each API call to provide an indication of the current progress and how long is left.
