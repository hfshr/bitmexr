...
Functions in `bitmexr` requiring authentication will use relevent key/secret when creating the encrypted signature to send to private API endpoints. You can use the testnet API to ensure the functions work as you'd expect prior to using the live API.
