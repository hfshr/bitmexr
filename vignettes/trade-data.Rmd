...
Without authentication, API requests are limited to 30 per minute. If you have enabled authentication by following you can use the `use_auth = TRUE` argument to access the higher rate limit of 60 requets per minute.
