...
Accessing privite API endpoints requires an API key and secret. `bitmexr` reads these from the ~/.Renviron file - see vignette "Authentication" for more information.
